...
import { PolymorphicComponentPropsWithRef, PolymorphicRef } from "../utils/testTypes";
...
type TextComponent = <C extends React.ElementType = "p">(props: TextProps<C>) => React.ReactElement | null;
